...
| `06_searxng_search_workflow.json` | Manual | `GET http://ai-trading-searxng:8080/search?format=json` | Private metasearch for agents (title/url/content). Draft by default. |
